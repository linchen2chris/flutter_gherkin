...
Future<void> main() {
  final config = FlutterDriverTestConfiguration(
    ...
    stepDefinitions: [thenExpectElementToHaveValue(), whenTapWidget()],
    reporters: [
    ...
    targetDeviceId:
        "chrome", // uncomment to run tests on all connected devices or set specific device target id
    // tagExpression: "@smock",
    ...
    // runningAppProtocolEndpointUri: 'http://127.0.0.1:62605/VK4vYxVj9Jk=/'
